                ...
                <div className={footerStyles.content}>
                    <div className={footerStyles.top}>
                        <div className={footerStyles['logo-details']}>
                            ...
                            <span className={footerStyles.logo_name}>Wikitech.io</span>
                        </div>
                    ...
                    <div className={footerStyles['link-boxes']}>
                        ...
                        <ul className={footerStyles.box}>
                            ...
                            <li><a href="#">CRM Consultency</a></li>
                            <li><a href="#">Salseforce</a></li>
                        </ul>
                        <ul className={footerStyles.box}>
                ...
                <div className={footerStyles['bottom-details']}>
                    <div className={footerStyles.bottom_text}>
                        <span className={footerStyles.copyright_text}> Copyright © 2024
                            <Link href="/>"> Wikitech.io.</Link> All rights reserved </span>
