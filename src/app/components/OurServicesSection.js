        ...
        <div className={styles.container}>
          ...
          <div className={styles.services}>
            <div className={styles.card}>
              ...
              <p>We are one of the best mobile development company that provides customers with the best Android, iOS, Hybrid, and Flutter mobile development solutions.</p>
              <button className={styles.learnMoreButton}>Learn More</button>
            </div>
            <div className={styles.card}>
              <FaDesktop className={styles.icon} />
              <h3>Web Development</h3>
              <p>We offers a wide array of web development services to augment, develop, manage, and better maintain your web material at a reasonable cost.</p>
              <button className={styles.learnMoreButton}>Learn More</button>
            </div>
            <div className={styles.card}>
