        ...
        >
          <Card
            ...
            sx={{
              ...
              outline: "1px solid",
              outlineColor:
                paymentType === "creditCard" ? "red.main" : "divider",
              backgroundColor:
          ...
          >
            <CardActionArea onClick={() => setPaymentType("creditCard")}>
              ...
              >
                <CreditCardRoundedIcon color="red" fontSize="small" />
          ...
          <Card
            ...
            sx={{
              ...
              outline: "1px solid",
              outlineColor:
                paymentType === "bankTransfer" ? "red.main" : "divider",
              backgroundColor:
          ...
          >
            <CardActionArea onClick={() => setPaymentType("bankTransfer")}>
              <CardContent
                sx={{ display: "flex", alignItems: "center", gap: 1 }}
              >
                <AccountBalanceRoundedIcon color="red" fontSize="small" />
      ...
      {paymentType === "creditCard" && (
        ...
        >
          ...
          <FormControlLabel
            ...
            label={
              <span style={{ fontSize: "1.2rem" }}>Remember card details</span>
            }
          />
        </Box>
      )}
